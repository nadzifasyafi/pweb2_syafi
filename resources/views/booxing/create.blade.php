      ...
      <form action='{{ route('booxing.store') }}' method='post'>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="string     " class="form-control" name='no_hp' id="no_hp">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <label for="tgl_booxing" class="col-sm-2 col-form-label">Tanggal Boxing</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" name='tgl_booxing' id="tgl_booxing">
                </div>
                <div class="col-sm-10"><button type="submit" class="btn btn-primary" name="submit">SIMPAN</button></div>
            </div>
            <a href='{{ url('booxing') }}' class="btn btn-secondary"><< kembali</a>
        </div>
